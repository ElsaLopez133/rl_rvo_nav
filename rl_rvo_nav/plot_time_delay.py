...
df = pd.read_csv('/home/elopezpe/catkin_ws/src/kale_bot/external/rl_rvo_nav/rl_rvo_nav/Experiments/rl_rvo_1_dis0_nr4_debug/time_delay_episode_0_step_0-1_vmax_linear1-5_vmax_angular1-5.csv')
...
name = '/home/elopezpe/catkin_ws/src/kale_bot/external/rl_rvo_nav/rl_rvo_nav/time_delay_omni_x.png'
title = 'Time delay'
axes.grid()
...
name = '/home/elopezpe/catkin_ws/src/kale_bot/external/rl_rvo_nav/rl_rvo_nav/time_delay_omni_y.png'
title = 'Time delay'
axes.grid()
axes.set_title(title)
plt.savefig(name)
...
axes.plot(np.array(df['time_stamp_init']),np.array(df['cur_vel_linear_x_init']),  color = 'blue', linestyle = '-',marker = '.')
...
name = '/home/elopezpe/catkin_ws/src/kale_bot/external/rl_rvo_nav/rl_rvo_nav/time_delay_linear_x.png'
title = 'Time delay'
axes.grid()
axes.set_title(title)
plt.savefig(name)
...
name = '/home/elopezpe/catkin_ws/src/kale_bot/external/rl_rvo_nav/rl_rvo_nav/time_delay_angular_z.png'
title = 'Time delay'
axes.grid()
axes.set_title(title)
plt.savefig(name)
